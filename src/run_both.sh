...
python main.py \
    ...
    --epochs 20 \
    --seed 1 \
    --savepath "data/saved_labevents_demo_seed1/" \
...
python main.py \
    ...
    --epochs 20 \
    --seed 18 \
    --savepath "data/saved_labevents_demo_seed18/" \
    --usedemographics True \
    --usenotes False \
    --uselabevents True
...
python main.py \
    ...
    --epochs 20 \
    --seed 3 \
    --savepath "data/saved_labevents_demo_seed3/" \
    --usedemographics True \
    --usenotes False \
    --uselabevents True
...
python main.py \
    ...
    --epochs 20 \
    --seed 16 \
    --savepath "data/saved_labevents_demo_seed16/" \
    --usedemographics True \
    --usenotes False \
    --uselabevents True
...
python main.py \
    ...
    --epochs 20 \
    --seed 1234 \
    --savepath "data/saved_labevents_demo_seed1234/" \
    --usedemographics True \
    --usenotes False \
    --uselabevents True
...
# python main.py --debug False --resume_path "../saved/mimic3/trained_model_0.4799" --Test False --dataset "mimic3" --device 0 --dp 0.5 --lr 0.0005 --dim 64 --regular 0.05 --epochs 20 --seed 1 --savepath "data/saved_labevents_demo_seed1/" --usedemographics True --usenotes False --uselabevents True