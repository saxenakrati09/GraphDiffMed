...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Test causal construction')
    parser.add_argument('--dataset', default='mimic3', choices=['mimic3', 'mimic4'], 
    ...
    # 测试样例
    data_path = f"../../data/{dataset}/output/records_final.pkl"
    voc_path = f"../../data/{dataset}/output/voc_final.pkl"
    ...
    causal_graph = CausaltyGraph4Visit(data, data_train, voc_size[0], voc_size[1], voc_size[2], dataset)
