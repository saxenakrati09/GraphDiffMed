...
python main.py \
    ...
    --epochs 20 \
    --seed 1 \
    --savepath "data/saved_attn_seed1/" \
...
python main.py \
    ...
    --epochs 20 \
    --seed 18 \
    --savepath "data/saved_attn_seed18/" \
    --usedemographics False \
    --usenotes False \
    --uselabevents False
...
python main.py \
    ...
    --epochs 20 \
    --seed 3 \
    --savepath "data/saved_attn_seed3/" \
    --usedemographics False \
    --usenotes False \
    --uselabevents False
...
python main.py \
    ...
    --epochs 20 \
    --seed 16 \
    --savepath "data/saved_attn_seed16/" \
    --usedemographics False \
    --usenotes False \
    --uselabevents False
...
python main.py \
    ...
    --epochs 20 \
    --seed 1234 \
    --savepath "data/saved_attn_seed1234/" \
    --usedemographics False \
    --usenotes False \
    --uselabevents False
